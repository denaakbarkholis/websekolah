...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="list-unstyled ">
            ...
            <li class="active"><a href="informasi.php"><i class="bi bi-question-circle"></i>Informasi</a></li>
            <!-- dropdown -->
            <li class="mydrop">
        ...
        <div class="container">
            <div id="dashboard">
                ...
                <div class="main-content">
                    ...
                    <a href="tambah-informasi.php"><button type="button"
                    ...
                    <table class="tabel mx-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?= $no++ ?></td>
                                <td class="col-2"><?= $p['judul'] ?></td>
                                <td class="col-5"><?= substr($p['keterangan'], 0, 100) ?></td>
                                <td class="text-center"><img src="../uploads/informasi/<?= $p['gambar'] ?>"
                                        width="200px" alt=""></td>

                                <td class="text-center mx-auto">
                                    <a href="edit-informasi.php?idinformasi=<?= $p['id'] ?>"><button type="button"
