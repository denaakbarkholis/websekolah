                ...
                <div class="main-content pt-4">
                    ...
                    <form action="" method="post" class="ms-3 me-3" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="keterangan" aria-describedby="nama"
                                placeholder="Keterangan" value="<?= $p->keterangan ?>" required>
                        </div>

                        <div class=" mb-3">
                            <label class="form-label">Gambar</label>
                            <br>
                            <img src="../uploads/galeri/<?= $p->foto ?>" alt="" width="200px" class="image">
                            <br>
                        ...
                        <a href="galeri.php"><button type="button" class="btn btn-danger">Kembali</button></a>
                        ...
                        if($update) {
                                echo "<script>window.location='galeri.php?success=Data berhasil'</script>";
                            }
                            else{
