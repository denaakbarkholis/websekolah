...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="list-unstyled ">
            ...
            <li class="active"><a href="jurusan.php"><i class="bi bi-bookmark"></i>Jurusan</a></li>
        ...
        <div class="container">
            <div id="dashboard">
                ...
                <div class="main-content">
                    ...
                    <a href="tambah-jurusan.php"><button type="button"
                    ...
                    <table class="tabel mx-auto">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $p['nama'] ?></td>
                                <td><?= $p['keterangan'] ?></td>
                                <td class=" text-center"><img src="../uploads/jurusan/<?= $p['gambar'] ?>" width="100px"
                                        alt=""></td>

                                <td class="text-center mx-auto">
                                    <a href="edit-jurusan.php?idjurusan=<?= $p['id'] ?>"><button type="button"
